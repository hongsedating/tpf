...
@Generated(value = "Autogenerated by Thrift Compiler (0.9.3)", date = "2019-07-14")
public class CommunicationProtocol {
  ...
  public interface Iface {
       ...
       * @param data 请求参数，V1版本，参数可为空，但若不为空时，必须是Json格式
       * */
  ...
  public interface AsyncIface {
    ...
    public void process(ProtocolVersion version, String path, String data, AsyncMethodCallback resultHandler) throws TException;
  ...
  public static class Client extends org.apache.thrift.TServiceClient implements Iface {
    ...
    public String process(ProtocolVersion version, String path, String data) throws TException
    {
      send_process(version, path, data);
      return recv_process();
    }

    public void send_process(ProtocolVersion version, String path, String data) throws TException
    {
  ...
  public static class AsyncClient extends org.apache.thrift.async.TAsyncClient implements AsyncIface {
    ...
    public void process(ProtocolVersion version, String path, String data, AsyncMethodCallback resultHandler) throws TException {
      checkReady();
      process_call method_call = new process_call(version, path, data, resultHandler, this, ___protocolFactory, ___transport);
    ...
    public static class process_call extends org.apache.thrift.async.TAsyncMethodCall {
      ...
      private String path;
      private String data;
      public process_call(ProtocolVersion version, String path, String data, AsyncMethodCallback resultHandler, org.apache.thrift.async.TAsyncClient client, org.apache.thrift.protocol.TProtocolFactory protocolFactory, org.apache.thrift.transport.TNonblockingTransport transport) throws TException {
  ...
  public static class Processor<I extends Iface> extends org.apache.thrift.TBaseProcessor<I> implements org.apache.thrift.TProcessor {
    ...
    public static class process<I extends Iface> extends org.apache.thrift.ProcessFunction<I, process_args> {
      ...
      public process_result getResult(I iface, process_args args) throws TException {
        process_result result = new process_result();
        result.success = iface.process(args.version, args.path, args.data);
        return result;
      }
    }
  ...
  public static class AsyncProcessor<I extends AsyncIface> extends org.apache.thrift.TBaseAsyncProcessor<I> {
    ...
    public static class process<I extends AsyncIface> extends org.apache.thrift.AsyncProcessFunction<I, process_args, String> {
      ...
      public void start(I iface, process_args args, AsyncMethodCallback<String> resultHandler) throws TException {
        iface.process(args.version, args.path, args.data,resultHandler);
      }
    }
  ...
  public static class process_args implements org.apache.thrift.TBase<process_args, process_args._Fields>, java.io.Serializable, Cloneable, Comparable<process_args>   {
     ...
     * @see ProtocolVersion
     */
    public ProtocolVersion version; // required
    ...
    static {
      ...
      tmpMap.put(_Fields.VERSION, new org.apache.thrift.meta_data.FieldMetaData("version", org.apache.thrift.TFieldRequirementType.REQUIRED, 
          new org.apache.thrift.meta_data.EnumMetaData(org.apache.thrift.protocol.TType.ENUM, ProtocolVersion.class)));
     ...
     * @see ProtocolVersion
     */
    public process_args setVersion(ProtocolVersion version) {
      this.version = version;
      return this;
    }
    ...
    public process_args setPath(String path) {
      this.path = path;
      return this;
    }
    ...
    public process_args setData(String data) {
      this.data = data;
      return this;
    }
          ...
          switch (schemeField.id) {
            case 1: // VERSION
              if (schemeField.type == org.apache.thrift.protocol.TType.I32) {
                struct.version = ProtocolVersion.findByValue(iprot.readI32());
